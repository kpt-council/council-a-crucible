...
**ID** — COUNCIL-001-README | **Version** — 0.6 | **Author** — Kirk Thompson | council@mosen.net | **Developed in dialogue with** — Claude (Anthropic) | **Date** — 2026-02-22 | **Last updated** — 2026-03-07 15:29 MST | **Contact** — Questions and concerns welcome — practitioners and builders especially.
